...
const Navbar = () => {
  ...
  const [showForm, setShowForm] = useState(false); // NEW STATE for consultation form
        ...
        <div className="flex justify-between items-center relative">
          ...
          <div className="hidden lg:block z-10">
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-white font-semibold font-sans transition transform duration-200 hover:scale-110 active:scale-95 hover:text-white-300 active:text-pink-400"
            >
              Get a Quote
            </button>
          </div>
        ...
        {isOpen && (
          <div className="flex flex-col gap-4 mt-4 lg:hidden">
            ...
            <button
              ...
              setShowForm(true);        // show floating modal
              }}
              className="w-full text-center py-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-white font-semibold"
            >
            Get a Quote
            </button>
          </div>
