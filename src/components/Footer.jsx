...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white py-16 md:py-20 rounded-t-3xl">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-24">
          {/* Brand Info */}
          <div className="flex flex-col items-center md:items-start space-y-6">
            <div>
              <img src={logo} alt="logo image" className="h-10 bg-white" />
            </div>
            <p className="font-sans text-gray-300 text-lg leading-relaxed text-center md:text-left max-w-xs">
              We build innovative digital solutions that empower businesses.
              Partner with us for cutting-edge technology and impactful results.
            </p>
          </div>

          {/* Navigation Links */}
          <div className="flex flex-col items-center md:items-start space-y-4">
            <h4 className="font-sans text-2xl text-white font-semibold">
              Quick Links
            </h4>
        ...
        <div className="flex w-full justify-between items-center">
          ...
          <div className="flex justify-center gap-6 mt-8 md:mt-12">
            {socialLinks.map((link, index) => (
              <a
                key={index}
                href={link.href}
                className="text-gray-300 hover:text-cyan-500 transform hover:scale-110 transition-all duration-300"
          ...
          <div className="mt-12 text-center text-gray-400 text-sm">
            <p>
              &copy; {new Date().getFullYear()} Kynyx Solutions. All rights
              reserved.
            </p>
          </div>
        </div>
