          ...
          {services.map((service, index) => {
            ...
            return (
              <div
                ...
                className={`
                  bg-gray-800 p-6 sm:p-8 rounded-xl border border-gray-700
                  transition-all duration-300 ease-in-out transform
                  ${isAnyHovered && !isHovered ? 'opacity-0 scale-75 pointer-events-none' : 'opacity-100 scale-100'}
                  ${isHovered ? 'z-10 shadow-lg shadow-cyan-500/30 scale-105' : ''}
                `}
              >
